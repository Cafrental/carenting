    ...
    {make && (
      <div className="justify-center m-8">
        <div className="h-full border-solid border-2 border-black drop-shadow-lg bg-white hover:scale-105 transition duration-500 cursor-pointer">
          <div className="p-5">
            <button className='border-2 border-black bg-transparent text-xl font-medium text-gray-900 text-black p-1 rounded' onClick={[]}> Order </button>
          </div>
          <img className="" src={photoURL} alt={model}/>
          <div className="p-5">
            <p className="text-gray-900 text-xl font-medium mb-2">{make} {model} {year}</p>
            <p className="text-gray-600 text-xl font-medium">Location: Bialystok</p>
            <p className="text-gray-600 text-xl font-medium">Price: 100zl/km</p>
            <p className="text-gray-600 text-xl font-medium">Availability: Available</p>
          </div>
        </div>
      </div>
    )}
